...
declare module '../../index' {
  ...
  interface IAppIdOption extends BasicOption {
    /** 要打开的小程序 appId */
    appId: string
    /** 小程序链接，当传递该参数后，可以不传 appId 和 path。链接可以通过【小程序菜单】->【复制链接】获取。 */
    shortLink?: string
  }
  interface TLinkOption extends BasicOption {
    /** 要打开的小程序 appId */
    appId?: string
    /** 小程序链接，当传递该参数后，可以不传 appId 和 path。链接可以通过【小程序菜单】->【复制链接】获取。 */
    shortLink: string
  ...
  namespace openEmbeddedMiniProgram {
    type Option = IAppIdOption | TLinkOption
  }

  namespace navigateToMiniProgram {
    type Ignored = 'verify' | 'noRelaunchIfPathUnchanged'
    type Option = Omit<IAppIdOption, Ignored> | Omit<TLinkOption, Ignored>
  }

  namespace navigateBackMiniProgram {
    type Option = Pick<BasicOption, 'extraData' | 'success' | 'fail' | 'complete'>
  }

  namespace exitMiniProgram {
    type Option = Pick<BasicOption, 'success' | 'fail' | 'complete'>
  }
