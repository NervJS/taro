import { recursiveMerge, REG_SCRIPTS, REG_SASS_SASS, REG_SASS_SCSS, REG_LESS, REG_STYLUS, REG_STYLE, REG_MEDIA, REG_FONT, REG_IMAGE, REG_VUE } from '@tencent/tarojs-helper'
...
import { PostcssOption, IPostcssOption, ICopyOptions } from '@tencent/tarojs-taro/types/compile'
