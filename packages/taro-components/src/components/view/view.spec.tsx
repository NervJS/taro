...
describe('View', () => {
  ...
  it('should update props successfully', async () => {
    ...
    page.root?.setAttribute('hover-start-time', `${hoverStartTime}`)
    page.root?.setAttribute('hover-stay-time', `${hoverStayTime}`)
  ...
  it('should trigger longpress', async () => {
    ...
    page.root?.addEventListener('longpress', onLongPress)
