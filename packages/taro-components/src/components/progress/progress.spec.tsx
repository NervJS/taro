...
describe('Progress', () => {
  ...
  it('props', async () => {
    ...
    page.root?.setAttribute('percent', `${percent}`)
    page.root?.setAttribute('border-radius', `${borderRadius}`)
    page.root?.setAttribute('font-size', `${fontSize}`)
    page.root?.setAttribute('stroke-width', `${strokeWidth}`)
    ...
    bar = page.root?.querySelector('.weui-progress__bar')
    innerBar = page.root?.querySelector('.weui-progress__inner-bar')
    opr = page.root?.querySelector('.weui-progress__opr')
