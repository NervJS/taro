/**
 * 与 @tarojs/webpack5-runner 的 src/postcss/postcss.h5.ts 逻辑一致，独立维护一份。
 * getDefaultPostcssConfig 产出的 postcss-pxtransform 项同时用于 PostCSS 规则与
 * taro-loader/h5 的 pxTransformConfig。
 */
...
export const getDefaultPostcssConfig = function ({
  ...
  return [
    ...
    ['postcss-alias', { config: { alias } }, postcssAlias],
