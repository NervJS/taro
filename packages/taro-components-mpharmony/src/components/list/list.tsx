...
export default class ListView extends React.Component<IProps> {
  ...
  render () {
    ...
    if (this.props.padding != null && this.props.padding.length === 4) {
      padding_top = this.props.padding [0]
      padding_right = this.props.padding [1]
      padding_bottom = this.props.padding [2]
      padding_left = this.props.padding [3]
    }
