...
module.exports = function (creater, params, helper, cb) {
  ...
  exec('cp -R ' + creater.rootPath + '/templates/dva/src ' + sourceDir)
  ...
  creater.template(template, 'api', path.join(projectPath, 'api.js'))
  creater.template(template, 'apijson', path.join(projectPath, 'api.json'))
  if (typescript) {
