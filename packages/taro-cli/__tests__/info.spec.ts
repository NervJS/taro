...
describe('info', () => {
  ...
  it('should log infomations', async () => {
    ...
    expect(info.npmPackages.hasOwnProperty('@tencent/tarojs-helper')).toBeTruthy()
    expect(info.npmPackages.hasOwnProperty('@tencent/tarojs-mini-runner')).toBeTruthy()
    expect(info.npmPackages.hasOwnProperty('@tencent/tarojs-service')).toBeTruthy()
    expect(info.npmPackages.hasOwnProperty('@tencent/tarojs-taro')).toBeTruthy()
    expect(info.npmPackages.hasOwnProperty('@tencent/tarojs-taroize')).toBeTruthy()
    expect(info.npmPackages.hasOwnProperty('@tencent/tarojs-webpack-runner')).toBeTruthy()
