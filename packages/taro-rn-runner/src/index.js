...
exports.buildProd = function (config) {
  console.log()
  console.log(`Run ${chalk.cyan('exp build:android ')} or ${chalk.cyan('exp build:ios ')} to building standalone apps`)
  console.log(`you can visite ${chalk.cyan('https://docs.expo.io/versions/latest/distribution/building-standalone-apps')} for more info`)
  process.exit(1)
}
