...
import fileio from '@ohos.fileio' // FIXME
...
const rootDataPath = `/data/data/${get('NativePackageManager').loadLibrarySync('@system.app', [['getInfo'], ['appID']]) || 'app'}`
...
function getDirFiles (_dirPath: string): Promise<GetDirFilesResult> {
