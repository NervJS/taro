...
import { CallbackManager, temporarilyNotSupport } from '../utils'
...
export const hideKeyboard: typeof Taro.hideKeyboard = function (_options) {
  // FIXME @ohos.inputMethodEngine
