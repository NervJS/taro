    ...
    this.chain.merge({
      resolve: {
        ...
        alias: {
          ...
          '@tarojs/runtime': resolveSync('@tarojs/runtime', resolveOptions) || require.resolve('@tarojs/runtime'),
          '@tarojs/shared': resolveSync('@tarojs/shared', resolveOptions) || require.resolve('@tarojs/shared'),
        },
