...
import { noop, EMPTY_OBJ, EMPTY_ARR } from '@tarojs/shared'
...
> = {
  ...
  finalizeInitialChildren (dom, _, props) {
    updateProps(dom, EMPTY_OBJ, props)
    return false
  },
...
export const TaroRenderer = Reconciler(hostConfig)
