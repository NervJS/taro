import { hooks, isArray, isUndefined, Shortcuts, EMPTY_OBJ, warn, isString, toCamelCase, isFunction } from '@tarojs/shared'
import { TaroNode } from './node'
import { NodeType } from './node_types'
import { eventSource } from './event-source'
import { isElement, isHasExtractProp, shortcutAttr, extend } from '../utils'
