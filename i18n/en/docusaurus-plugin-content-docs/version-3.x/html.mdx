...
> Please note: All the contents of this section will only work on the applet side.
...
* `@tarojs/taro/html5.css`: [Chrome(Blink) HTML5 built-in styles](https://chromium.googlesource.com/chromium/blink/+/master/Source/core/css/html.css), Rich built-in styles, including most HTML5 tags, large size, not necessarily support all applet containers.
