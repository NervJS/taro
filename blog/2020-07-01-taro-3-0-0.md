...
在四类框架之外，Taro 3 还提供 [jQuery-like API](https://taro-docs.jd.com/taro/docs/jquery-like) 的支持，作为现代开发框架的补充和实现跨框架组件的方案。
...
你可以访问文档[渲染 HTML](https://taro-docs.jd.com/taro/docs/html)了解更多信息。
...
你可以访问文档[使用 CSS-in-JS](https://taro-docs.jd.com/taro/docs/css-in-js)了解更多信息。
...
你可以访问文档[长列表渲染](https://taro-docs.jd.com/taro/docs/virtual-list.html)了解更多信息。
...
你可以访问文档[预渲染](https://taro-docs.jd.com/taro/docs/prerender)了解更多信息。
