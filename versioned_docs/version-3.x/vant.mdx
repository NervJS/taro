...
>
> 如果你想使用 vant Weapp 又想拥有多端转换的能力，可以尝试一下 vant Weapp 社区衍生库，  [@antmjs/vantui](https://github.com/AntmJS/vantui) 基于 Vant Weapp 开发的多端组件库，同时支持 Taro 和 React。拥有 Taro 多端转换的能力，和 vant Weapp 一样好看的UI风格，一样好用的组件API。
