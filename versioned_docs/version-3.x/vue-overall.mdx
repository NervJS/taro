...
:::info
[Breaking] 旧项目升级到 Taro v3.4+ 时，使用 Vue2 请安装依赖 `@tarojs/plugin-framework-vue2`、使用 Vue2 请安装依赖 `@tarojs/plugin-framework-vue3`、
:::
...
4. 在Vue中使用jsx时，事件名称的首字母需要大写，例如`onGetphonenumber`。
