    ...
    return (
      <View className='components-page'>
        <View className='components-page__header'>
          ...
          <ComponentState platform='H5' rate='90'>
            {' '}
          </ComponentState>
        </View>
        <View className='components-page__body'>
          <View className='page-section'>
            ...
            <MovableArea className='movable-area'>
              <MovableView className='movable-view' x={this.state.x} y={this.state.y} direction='all'>
                text
              </MovableView>
            </MovableArea>
          </View>
          <View className='btn-area'>
            <Button onClick={this.tap} className='page-body-button' type='primary'>
              点击移动到 (30px, 30px)
            </Button>
          </View>
          ...
          <View className='page-section'>
            ...
            <MovableArea className='movable-area'>
              <MovableView className='movable-view' class='max' direction='all'>
                text
              </MovableView>
            </MovableArea>
          </View>
          ...
          <View className='page-section'>
            ...
            <MovableArea className='movable-area'>
              <MovableView className='movable-view' direction='all' out-of-bounds>
                text
              </MovableView>
            </MovableArea>
          </View>
          ...
          <View className='page-section'>
            ...
            <MovableArea className='movable-area'>
              <MovableView className='movable-view' direction='all' inertia>
                text
              </MovableView>
            </MovableArea>
          </View>
          ...
          <View className='btn-area'>
            <Button onClick={this.tap2} className='page-body-button' type='primary'>
              点击放大3倍
            </Button>
          </View>
        </View>
