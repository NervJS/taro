<a name=""></a>
# [](https://github.com/NervJS/taro/compare/v1.3.25...v) (2019-11-19)


### Bug Fixes

* **cli:** lerna 加入 taro-mini-runner && 接入 webpack 生成小程序文件 ([c463c45](https://github.com/NervJS/taro/commit/c463c45))
* **cli:** 修复 doctor 对 config 的检测 ([20b1103](https://github.com/NervJS/taro/commit/20b1103))
* **cli:** 修复 watch 时文件修改不对的问题 ([06a89ea](https://github.com/NervJS/taro/commit/06a89ea))
* **cli:** 修复代码合并的问题 ([04415c6](https://github.com/NervJS/taro/commit/04415c6))
* **cli:** 修复目录创建 ([b11a05f](https://github.com/NervJS/taro/commit/b11a05f))
* **cli:** 修复配置文件中读取不到 process.env.TARO_ENV 的问题 ([28eab2f](https://github.com/NervJS/taro/commit/28eab2f))
* **cli:** 支持引用 node_modules 中组件 ([d123b94](https://github.com/NervJS/taro/commit/d123b94))
* **cli:** 普通文件经过编译器编译必须传入 isNormal ([97b905a](https://github.com/NervJS/taro/commit/97b905a))
* **cli:** 更新默认模板 ([04d1206](https://github.com/NervJS/taro/commit/04d1206))
* **cli:** 清理代码 ([b4b5efc](https://github.com/NervJS/taro/commit/b4b5efc))
* **cli:** 编译器参数调整 ([f8c0813](https://github.com/NervJS/taro/commit/f8c0813))
* **components-qa:** 修复页面 onReachBottom 事件不触发的问题 ([5d2d558](https://github.com/NervJS/taro/commit/5d2d558))
* **jd:** 修复合并代码导致的京东小程序的编译问题 ([888b53b](https://github.com/NervJS/taro/commit/888b53b))
* **mini-runner:** npm 中文件不会经过 taro 包替换操作 ([9ea0e42](https://github.com/NervJS/taro/commit/9ea0e42))
* **mini-runner:** 优化 webpack 编译时样式处理 ([f6d6d67](https://github.com/NervJS/taro/commit/f6d6d67))
* **mini-runner:** 修复 builder 的 hooks 调用 ([c8cdc93](https://github.com/NervJS/taro/commit/c8cdc93))
* **mini-runner:** 修复 tabbar 编译及组件 watch 的问题 ([4a67ae9](https://github.com/NervJS/taro/commit/4a67ae9))
* **mini-runner:** 修复 watch bug ([edbf72c](https://github.com/NervJS/taro/commit/edbf72c))
* **mini-runner:** 修复对 alias 的支持 ([64d1ada](https://github.com/NervJS/taro/commit/64d1ada))
* **mini-runner:** 修复对 css modules 的支持 ([0596ed9](https://github.com/NervJS/taro/commit/0596ed9))
* **mini-runner:** 修复小程序编译报错 ([71b7c8b](https://github.com/NervJS/taro/commit/71b7c8b))
* **mini-runner:** 修复引用 npm 中组件间存在依赖时依赖路径解析错误的问题 ([68a5e54](https://github.com/NervJS/taro/commit/68a5e54))
* **mini-runner:** 修复快应用打包报错的问题 ([3b37b7a](https://github.com/NervJS/taro/commit/3b37b7a))
* **mini-runner:** 修复快应用编译后页面标题展示不正确的问题 ([de309e4](https://github.com/NervJS/taro/commit/de309e4))
* **mini-runner:** 修复普通小程序编译的问题 ([4354168](https://github.com/NervJS/taro/commit/4354168))
* **mini-runner:** 加上文件编译提示 ([4fdf764](https://github.com/NervJS/taro/commit/4fdf764))
* **mini-runner:** 更新编译时提示 ([e48ba2f](https://github.com/NervJS/taro/commit/e48ba2f))
* **mini-runner:** 移除无用代码 ([0f8ded1](https://github.com/NervJS/taro/commit/0f8ded1))
* **mini-runner:** 组件引入支持统一从一个入口文件中引入 ([5cd4c93](https://github.com/NervJS/taro/commit/5cd4c93))
* **taro-cli:** update package list 新增 [@tarojs](https://github.com/tarojs)/mini-runner，对列表排序 ([2167b04](https://github.com/NervJS/taro/commit/2167b04))
* position linter for quickapp 1060+ ([1ac04f1](https://github.com/NervJS/taro/commit/1ac04f1))
* pxtransform disable on quick-app ([ca299f4](https://github.com/NervJS/taro/commit/ca299f4))
* quickapp api upload from docs ([61f5547](https://github.com/NervJS/taro/commit/61f5547))
* somethings no need ([95d41cd](https://github.com/NervJS/taro/commit/95d41cd))
* **mini-runner:** 只有 taro 的包不能经过依赖包名替换 ([f7f6232](https://github.com/NervJS/taro/commit/f7f6232))
* **mini-runner:** 打包优化，引用自 npm 包中的组件不抽离至 vendors 中 ([dcd0ed4](https://github.com/NervJS/taro/commit/dcd0ed4))
* **mini-runner:** 提前解析快应用页面 ([a58c192](https://github.com/NervJS/taro/commit/a58c192))
* **mini-runner:** 支持快应用编译后模板与样式的检测 ([0ab1e06](https://github.com/NervJS/taro/commit/0ab1e06))
* **quickapp:** pull-down-refresh page-scroll ([6194141](https://github.com/NervJS/taro/commit/6194141))
* **taro:** 修复快应用下拉刷新问题 ([7fb9dcf](https://github.com/NervJS/taro/commit/7fb9dcf))
* **taro:** 小程序 webpack 编译静态文件路径 ([c04ac8b](https://github.com/NervJS/taro/commit/c04ac8b))
* **taro-quickapp:** 修复快应用事件绑定异常问题 ([12e398a](https://github.com/NervJS/taro/commit/12e398a))
* **transformer:** 修复测试用例 ([414654e](https://github.com/NervJS/taro/commit/414654e))
* **transformer:** 修复错误类型 ([3d018ff](https://github.com/NervJS/taro/commit/3d018ff))
* **transformer:** 支持直接 import  default ([67aee0f](https://github.com/NervJS/taro/commit/67aee0f))
* **webpack:** 修复文件压缩的问题 ([499a363](https://github.com/NervJS/taro/commit/499a363))


### Features

* **docs:** 更新 2.0 版本使用 async-await 的文档 [#4837](https://github.com/NervJS/taro/issues/4837) ([da79507](https://github.com/NervJS/taro/commit/da79507))
* audio context ([9c98655](https://github.com/NervJS/taro/commit/9c98655))
* mock for quickapp ([fa2238b](https://github.com/NervJS/taro/commit/fa2238b))
* stop trans asset for quickapp ([dfacc0f](https://github.com/NervJS/taro/commit/dfacc0f))
* **cli:** cli 支持事件 && 小程序编译配置向 H5 看齐 ([93c57fc](https://github.com/NervJS/taro/commit/93c57fc))
* **cli:** 借助 tapable 改造 ([91bd922](https://github.com/NervJS/taro/commit/91bd922))
* **cli:** 增加 tapable 包 ([38e7a40](https://github.com/NervJS/taro/commit/38e7a40))
* **cli:** 将 app/页面/组件 添加到入口文件进行编译 ([9df79d5](https://github.com/NervJS/taro/commit/9df79d5))
* **cli:** 尝试接入 webpack 来编译各端小程序 ([41e3dc1](https://github.com/NervJS/taro/commit/41e3dc1))
* **cli:** 拆分逻辑到 loader ([1a202c2](https://github.com/NervJS/taro/commit/1a202c2))
* **cli:** 调整文件编译 ([9b8fc7f](https://github.com/NervJS/taro/commit/9b8fc7f))
* **mini-runner:** 优化 watch ([ea4b3d2](https://github.com/NervJS/taro/commit/ea4b3d2))
* **mini-runner:** 保证快应用文件生成正确 ([908d599](https://github.com/NervJS/taro/commit/908d599))
* **mini-runner:** 加入 watch ([3ede139](https://github.com/NervJS/taro/commit/3ede139))
* **mini-runner:** 增加 Taro 模块专有处理插件 ([af73e21](https://github.com/NervJS/taro/commit/af73e21))
* **mini-runner:** 支持与原生小程序代码混写 ([eb825e9](https://github.com/NervJS/taro/commit/eb825e9))
* **mini-runner:** 支持分包 ([b93c023](https://github.com/NervJS/taro/commit/b93c023))
* **mini-runner:** 支持编译 tabBar 上引用的资源编译 ([744a81b](https://github.com/NervJS/taro/commit/744a81b))
* **mini-runner:** 生成快应用页面及组件 ([73ed092](https://github.com/NervJS/taro/commit/73ed092))
* **taro:** cli 配合 mini-runner 重构 && 支持使用 mini-runner 编译插件 ([d39a248](https://github.com/NervJS/taro/commit/d39a248))
* **taro:** 加入快应用编译支持 ([29e334a](https://github.com/NervJS/taro/commit/29e334a))
* **taro:** 调整小程序和 H5 的编译配置 ([7b27712](https://github.com/NervJS/taro/commit/7b27712))
* **taro-cli:** 调整 rn 编译配置 ([f1078fa](https://github.com/NervJS/taro/commit/f1078fa))
* **taro-mini-runner:** 优化文件生成 ([321557d](https://github.com/NervJS/taro/commit/321557d))
* **taro-mini-runner:** 如果是组件需要补充 component:true 配置 ([81dca3b](https://github.com/NervJS/taro/commit/81dca3b))
* **taro-mini-runner:** 引入拆分的公共 chunks ([03ed259](https://github.com/NervJS/taro/commit/03ed259))
* **taro-mini-runner:** 拆分文件编译成为 plugin ([25d1d12](https://github.com/NervJS/taro/commit/25d1d12))
* **taro-mini-runner:** 生成多端类型文件 ([badbee3](https://github.com/NervJS/taro/commit/badbee3))
* **taro-mini-runner:** 生成页面以及组件的 usingComponents 配置 ([3fb48da](https://github.com/NervJS/taro/commit/3fb48da))
