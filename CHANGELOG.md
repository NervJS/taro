...
* **cli:** 修复 watch 时文件修改不对的问题 ([37fc95a](https://github.com/NervJS/taro/commit/37fc95a))
...
* **mini-runner:** 支持编译 tabBar 上引用的资源编译 ([20ec6d3](https://github.com/NervJS/taro/commit/20ec6d3))
