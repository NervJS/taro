...
=======
# [](https://github.com/NervJS/taro/compare/v2.0.0-beta.12...v) (2019-12-26)



<a name="2.0.0-beta.12"></a>
# [2.0.0-beta.12](https://github.com/NervJS/taro/compare/v1.3.33...v2.0.0-beta.12) (2019-12-26)
>>>>>>> 907e5e9d78fe03bc8329a833f38e10ed564f2799
...
=======
* **cli:** 2.0.0-beta.8. 编译RN报错 'babel' of undefined close [#5093](https://github.com/NervJS/taro/issues/5093) ([04ca457](https://github.com/NervJS/taro/commit/04ca457))
* **cli:** 修正快应用依赖项安装命令在windows不兼容问题 ([#4954](https://github.com/NervJS/taro/issues/4954)) ([ac6d3e5](https://github.com/NervJS/taro/commit/ac6d3e5))
* **cli:** 增加运行提示 ([2aaae47](https://github.com/NervJS/taro/commit/2aaae47))
* **cli:** 插件编译失败，close [#5149](https://github.com/NervJS/taro/issues/5149) ([665beaf](https://github.com/NervJS/taro/commit/665beaf))
* **cli:** 更新默认模板 ([b62a127](https://github.com/NervJS/taro/commit/b62a127))
* **cli:** 解决 cli 编译时缺少 [@types](https://github.com/types)/react 依赖问题 ([#4997](https://github.com/NervJS/taro/issues/4997)) ([b7de90a](https://github.com/NervJS/taro/commit/b7de90a))
* **components-qa:** 改进 button 动画效果展示，引入 css 属性描述文件 ([#4898](https://github.com/NervJS/taro/issues/4898)) ([93db089](https://github.com/NervJS/taro/commit/93db089))
* **mini-runner:** 优化 watch 时文件编译速度 ([161a418](https://github.com/NervJS/taro/commit/161a418))
* **mini-runner:** 修复 defineConstants 小程序表现与 H5 不一致问题 close [#5078](https://github.com/NervJS/taro/issues/5078) ([d0d8809](https://github.com/NervJS/taro/commit/d0d8809))
* **mini-runner:** 修复 sass 变量失效的问题，close [#4893](https://github.com/NervJS/taro/issues/4893) ([d6cb4b0](https://github.com/NervJS/taro/commit/d6cb4b0))
* **mini-runner:** 修复 watch 时增加组件文件的 bug，close [#5140](https://github.com/NervJS/taro/issues/5140) ([c2ca52f](https://github.com/NervJS/taro/commit/c2ca52f))
* **mini-runner:** 修复 watch 时文件报错导致无法重新编译的问题，fix [#4949](https://github.com/NervJS/taro/issues/4949) ([868ee13](https://github.com/NervJS/taro/commit/868ee13))
* **mini-runner:** 修复 windows 下编译后 taro 引用错误的问题 ([98b5798](https://github.com/NervJS/taro/commit/98b5798))
* **mini-runner:** 修复使用 preval 报错的问题 ([4ed22d6](https://github.com/NervJS/taro/commit/4ed22d6))
* **mini-runner:** 修复分包页面丢失的问题 ([2900e8d](https://github.com/NervJS/taro/commit/2900e8d))
* **mini-runner:** 修复包未安装不报错的问题 ([389c85a](https://github.com/NervJS/taro/commit/389c85a))
* **mini-runner:** 修复多端文件引用的问题，close [#5175](https://github.com/NervJS/taro/issues/5175) ([e4c8844](https://github.com/NervJS/taro/commit/e4c8844))
* **mini-runner:** 修复对 alias 的支持 ([dfb44a3](https://github.com/NervJS/taro/commit/dfb44a3))
* **mini-runner:** 修复小程序编译时样式中引用静态资源转换为 base64 ([6dcade6](https://github.com/NervJS/taro/commit/6dcade6))
* **mini-runner:** 修复引用原生组件报错的问题 ([6e72039](https://github.com/NervJS/taro/commit/6e72039))
* **mini-runner:** 修复引用原生组件编译后样式文件缺失的问题 ([d27c27c](https://github.com/NervJS/taro/commit/d27c27c))
* **mini-runner:** 修复静态资源引用的 bug ([7690d0d](https://github.com/NervJS/taro/commit/7690d0d))
* **mini-runner:** 修复页面 hooks config 失效问题 ([ce60975](https://github.com/NervJS/taro/commit/ce60975))
* **mini-runner:** 修正快应用pages中ux文件未正确生成问题 ([#4969](https://github.com/NervJS/taro/issues/4969)) ([18f7e18](https://github.com/NervJS/taro/commit/18f7e18))
* **mini-runner:** 加入 preval 支持 ([177fb94](https://github.com/NervJS/taro/commit/177fb94))
* **mini-runner:** 增加快应用公共属性的自动更新，优化button动画直接调用 ([#5044](https://github.com/NervJS/taro/issues/5044)) ([1da6b27](https://github.com/NervJS/taro/commit/1da6b27))
* **mini-runner:** 快应用页面路径编译错误 ([14e3dbb](https://github.com/NervJS/taro/commit/14e3dbb))
* **mini-runner:** 暴露 commonChunks 配置以供自定义公共 chunks 生成 ([ec98914](https://github.com/NervJS/taro/commit/ec98914))
* **mini-runner:** 更新编译时提示 ([d6dbb7e](https://github.com/NervJS/taro/commit/d6dbb7e))
* **mini-runner:** 移除无用代码 ([dca8ab8](https://github.com/NervJS/taro/commit/dca8ab8))
* **mini-runner:** 组件中 $componentPath 路径生成不对 ([72dd414](https://github.com/NervJS/taro/commit/72dd414))
* **mini-runner:** 组件引入支持统一从一个入口文件中引入 ([1ecf6a4](https://github.com/NervJS/taro/commit/1ecf6a4))
* **mini-runner:** 组件引用支持 import as 语法 ([9bd3b19](https://github.com/NervJS/taro/commit/9bd3b19))
* **mini-runner:** 编译时移除组件文件引用，遗漏了 npm 包中组件，close [#5139](https://github.com/NervJS/taro/issues/5139) ([752d0fc](https://github.com/NervJS/taro/commit/752d0fc))
* **mini-runner:** 编译时需要移除对组件文件的引用 ([71ff663](https://github.com/NervJS/taro/commit/71ff663))
* **mini-runner:** 降低 babel-plugin-preval 版本以保证使用 async await 时不报错 ([fbda921](https://github.com/NervJS/taro/commit/fbda921))
* **taro:** update getStorage return typings ([#5170](https://github.com/NervJS/taro/issues/5170)) ([ef636ca](https://github.com/NervJS/taro/commit/ef636ca))
* **types:** add enableFlex to ScrollViewProps ([#5142](https://github.com/NervJS/taro/issues/5142)) ([33d4286](https://github.com/NervJS/taro/commit/33d4286))
* for video objectFit ([5e9fee9](https://github.com/NervJS/taro/commit/5e9fee9))
* use rimraf instead of rm to fixed Windows build error ([151f065](https://github.com/NervJS/taro/commit/151f065))
* **quickapp:** pull-down-refresh page-scroll ([a888c20](https://github.com/NervJS/taro/commit/a888c20))
* **taro:** 增加递归查找中止条件，修正拼写错误 ([#5045](https://github.com/NervJS/taro/issues/5045)) ([d0ca0a0](https://github.com/NervJS/taro/commit/d0ca0a0))
* **taro-cli:** update package list 新增 [@tarojs](https://github.com/tarojs)/mini-runner，对列表排序 ([d76aea0](https://github.com/NervJS/taro/commit/d76aea0))
* **taro-runner-utils:** 优化代码，修复找不到类型定义的问题 ([c1828ee](https://github.com/NervJS/taro/commit/c1828ee))
* **taro-webpack-runner:** 修复 sassLoaderOption 未定义的问题 ([17c1fd3](https://github.com/NervJS/taro/commit/17c1fd3))
* **template:** 更新 Taro 2.0 的模版和下载地址 [#4837](https://github.com/NervJS/taro/issues/4837) ([8280309](https://github.com/NervJS/taro/commit/8280309))
* somethings no need ([51abf44](https://github.com/NervJS/taro/commit/51abf44))
* **cli:** lerna 加入 taro-mini-runner && 接入 webpack 生成小程序文件 ([961e2f6](https://github.com/NervJS/taro/commit/961e2f6))
* **cli:** 修复 doctor 对 config 的检测 ([f832dd6](https://github.com/NervJS/taro/commit/f832dd6))
* **cli:** 修复 watch 时文件修改不对的问题 ([40eeab2](https://github.com/NervJS/taro/commit/40eeab2))
* **cli:** 修复代码合并的问题 ([036578e](https://github.com/NervJS/taro/commit/036578e))
* **cli:** 修复目录创建 ([8a18681](https://github.com/NervJS/taro/commit/8a18681))
* **cli:** 当前主版本无稳定版本导致更新报错的问题，并添加文档 ([7852967](https://github.com/NervJS/taro/commit/7852967))
* **cli:** 支持引用 node_modules 中组件 ([9d07a89](https://github.com/NervJS/taro/commit/9d07a89))
* **components-qa:** 修复页面 onReachBottom 事件不触发的问题 ([d7b61b4](https://github.com/NervJS/taro/commit/d7b61b4))
* **mini-runner:** 修复快应用打包报错的问题 ([e805d76](https://github.com/NervJS/taro/commit/e805d76))
* quickapp api upload from docs ([778d847](https://github.com/NervJS/taro/commit/778d847))
* **cli:** 修复配置文件中读取不到 process.env.TARO_ENV 的问题 ([f78bd65](https://github.com/NervJS/taro/commit/f78bd65))
* **cli:** 普通文件经过编译器编译必须传入 isNormal ([b3ac158](https://github.com/NervJS/taro/commit/b3ac158))
* **cli:** 更新默认模板 ([7a4085d](https://github.com/NervJS/taro/commit/7a4085d))
* **cli:** 清理代码 ([bd554ee](https://github.com/NervJS/taro/commit/bd554ee))
* **cli:** 编译器参数调整 ([d7fb83d](https://github.com/NervJS/taro/commit/d7fb83d))
* **cli:** 获取到确切的 latest vertion ([d7f2ca5](https://github.com/NervJS/taro/commit/d7f2ca5))
* **components:** h5 image 删除无关代码 ([#4998](https://github.com/NervJS/taro/issues/4998)) ([545d8f3](https://github.com/NervJS/taro/commit/545d8f3))
* **components:** 修复 Image 组件在 react 环境下报错的问题 ([a9b3615](https://github.com/NervJS/taro/commit/a9b3615))
* **h5:** h5环境previewImage左右滑动时触发浏览器前进、后退 ([c3c9929](https://github.com/NervJS/taro/commit/c3c9929))
* **jd:** 修复合并代码导致的京东小程序的编译问题 ([2ce687b](https://github.com/NervJS/taro/commit/2ce687b))
* **mini-runner:** npm 中文件不会经过 taro 包替换操作 ([9fca37d](https://github.com/NervJS/taro/commit/9fca37d))
* **mini-runner:** 优化 webpack 编译时样式处理 ([59385c7](https://github.com/NervJS/taro/commit/59385c7))
* **mini-runner:** 修复 builder 的 hooks 调用 ([38f571d](https://github.com/NervJS/taro/commit/38f571d))
* **mini-runner:** 修复 tabbar 编译及组件 watch 的问题 ([ecc8553](https://github.com/NervJS/taro/commit/ecc8553))
* **mini-runner:** 修复 watch bug ([865c5a1](https://github.com/NervJS/taro/commit/865c5a1))
* **mini-runner:** 修复对 css modules 的支持 ([af14d8f](https://github.com/NervJS/taro/commit/af14d8f))
* **mini-runner:** 修复小程序编译报错 ([8ce3f82](https://github.com/NervJS/taro/commit/8ce3f82))
* **mini-runner:** 修复引用 npm 中组件间存在依赖时依赖路径解析错误的问题 ([482ac4b](https://github.com/NervJS/taro/commit/482ac4b))
* **mini-runner:** 修复快应用编译后页面标题展示不正确的问题 ([4cc0d4d](https://github.com/NervJS/taro/commit/4cc0d4d))
* **mini-runner:** 修复普通小程序编译的问题 ([d348879](https://github.com/NervJS/taro/commit/d348879))
* **mini-runner:** 加上文件编译提示 ([ef327b3](https://github.com/NervJS/taro/commit/ef327b3))
* **mini-runner:** 只有 taro 的包不能经过依赖包名替换 ([bc1f971](https://github.com/NervJS/taro/commit/bc1f971))
* **mini-runner:** 打包优化，引用自 npm 包中的组件不抽离至 vendors 中 ([1b7f491](https://github.com/NervJS/taro/commit/1b7f491))
* **mini-runner:** 提前解析快应用页面 ([f6e855c](https://github.com/NervJS/taro/commit/f6e855c))
* **mini-runner:** 支持快应用编译后模板与样式的检测 ([25080e9](https://github.com/NervJS/taro/commit/25080e9))
* **taro:** 修复快应用下拉刷新问题 ([b5aee68](https://github.com/NervJS/taro/commit/b5aee68))
* position linter for quickapp 1060+ ([22efa4d](https://github.com/NervJS/taro/commit/22efa4d))
* **taro:** 小程序 webpack 编译静态文件路径 ([7408f70](https://github.com/NervJS/taro/commit/7408f70))
* **taro-quickapp:** 修复快应用事件绑定异常问题 ([1c37295](https://github.com/NervJS/taro/commit/1c37295))
* pxtransform disable on quick-app ([3eecc2f](https://github.com/NervJS/taro/commit/3eecc2f))
...
* **transformer:** 修复测试用例 ([6f010ae](https://github.com/NervJS/taro/commit/6f010ae))
* **transformer:** 修复错误类型 ([7eefbea](https://github.com/NervJS/taro/commit/7eefbea))
* **transformer:** 支持直接 import  default ([84dbc7a](https://github.com/NervJS/taro/commit/84dbc7a))
* **webpack:** 修复文件压缩的问题 ([1094923](https://github.com/NervJS/taro/commit/1094923))
>>>>>>> 907e5e9d78fe03bc8329a833f38e10ed564f2799
...
=======
* **taro-runner-utils:** 添加单元测试和优化注释 ([ba5902a](https://github.com/NervJS/taro/commit/ba5902a))
* webpack-runner 和 mini-runner 代码优化 ([07a1cf3](https://github.com/NervJS/taro/commit/07a1cf3))
* **cli:**  添加了 version 校验 ([325e6d2](https://github.com/NervJS/taro/commit/325e6d2))
* **cli:** cli 支持事件 && 小程序编译配置向 H5 看齐 ([206b96e](https://github.com/NervJS/taro/commit/206b96e))
* **cli:** 借助 tapable 改造 ([09f3f41](https://github.com/NervJS/taro/commit/09f3f41))
* **cli:** 增加 tapable 包 ([51c5f79](https://github.com/NervJS/taro/commit/51c5f79))
* **cli:** 将 app/页面/组件 添加到入口文件进行编译 ([7856a48](https://github.com/NervJS/taro/commit/7856a48))
* **cli:** 尝试接入 webpack 来编译各端小程序 ([b5f5c0b](https://github.com/NervJS/taro/commit/b5f5c0b))
* **cli:** 拆分逻辑到 loader ([0cb27f1](https://github.com/NervJS/taro/commit/0cb27f1))
* **cli:** 调整文件编译 ([76d989e](https://github.com/NervJS/taro/commit/76d989e))
* **components-qa:** 增强快应用button组件，增加属性判断及点击变色等 ([#4882](https://github.com/NervJS/taro/issues/4882)) ([b13ac88](https://github.com/NervJS/taro/commit/b13ac88))
* **docs:** 更新 2.0 版本使用 async-await 的文档 [#4837](https://github.com/NervJS/taro/issues/4837) ([c899dad](https://github.com/NervJS/taro/commit/c899dad))
* **mini-runner:** 优化 watch ([5cb58f3](https://github.com/NervJS/taro/commit/5cb58f3))
* **mini-runner:** 保证快应用文件生成正确 ([71117f5](https://github.com/NervJS/taro/commit/71117f5))
* **mini-runner:** 加入 watch ([5edc9ad](https://github.com/NervJS/taro/commit/5edc9ad))
* **mini-runner:** 增加 Taro 模块专有处理插件 ([ae079ed](https://github.com/NervJS/taro/commit/ae079ed))
* **mini-runner:** 支持与原生小程序代码混写 ([2f83b04](https://github.com/NervJS/taro/commit/2f83b04))
* **mini-runner:** 支持分包 ([897930d](https://github.com/NervJS/taro/commit/897930d))
* **mini-runner:** 支持编译 tabBar 上引用的资源编译 ([ba3f457](https://github.com/NervJS/taro/commit/ba3f457))
* **mini-runner:** 生成快应用页面及组件 ([29ecad1](https://github.com/NervJS/taro/commit/29ecad1))
* **taro:** cli 配合 mini-runner 重构 && 支持使用 mini-runner 编译插件 ([dc42dde](https://github.com/NervJS/taro/commit/dc42dde))
* **taro-cli:** 配置文件分开存放，优化 taro config 输出 ([86a3e23](https://github.com/NervJS/taro/commit/86a3e23))
* **taro-runner-utils:** 添加 [@tarojs](https://github.com/tarojs)/runner-utils 包 ([eff7028](https://github.com/NervJS/taro/commit/eff7028))
* audio context ([8cbfe51](https://github.com/NervJS/taro/commit/8cbfe51))
* mock for quickapp ([4534ccd](https://github.com/NervJS/taro/commit/4534ccd))
* stop trans asset for quickapp ([183b8c4](https://github.com/NervJS/taro/commit/183b8c4))
* **taro:** 加入快应用编译支持 ([18f1abc](https://github.com/NervJS/taro/commit/18f1abc))
* **taro:** 调整小程序和 H5 的编译配置 ([b5ae833](https://github.com/NervJS/taro/commit/b5ae833))
* **taro-cli:** 调整 rn 编译配置 ([c73b6e8](https://github.com/NervJS/taro/commit/c73b6e8))
* **taro-mini-runner:** 优化文件生成 ([970a494](https://github.com/NervJS/taro/commit/970a494))
* **taro-mini-runner:** 如果是组件需要补充 component:true 配置 ([2322c01](https://github.com/NervJS/taro/commit/2322c01))
* **taro-mini-runner:** 引入拆分的公共 chunks ([64fa0ef](https://github.com/NervJS/taro/commit/64fa0ef))
* **taro-mini-runner:** 拆分文件编译成为 plugin ([356e46e](https://github.com/NervJS/taro/commit/356e46e))
* **taro-mini-runner:** 生成多端类型文件 ([fc02833](https://github.com/NervJS/taro/commit/fc02833))
* **taro-mini-runner:** 生成页面以及组件的 usingComponents 配置 ([c1664b7](https://github.com/NervJS/taro/commit/c1664b7))
* checkout from auto-docs ([b725c88](https://github.com/NervJS/taro/commit/b725c88))
>>>>>>> 907e5e9d78fe03bc8329a833f38e10ed564f2799
