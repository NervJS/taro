...
# [2.0.0-beta.5](https://github.com/NervJS/taro/compare/v1.3.27...v2.0.0-beta.5) (2019-12-03)
...
* **cli:** 修正快应用依赖项安装命令在windows不兼容问题 ([#4954](https://github.com/NervJS/taro/issues/4954)) ([20c9563](https://github.com/NervJS/taro/commit/20c9563))
...
* **cli:** 更新默认模板 ([95645e7](https://github.com/NervJS/taro/commit/95645e7))
...
* **cli:** 解决 cli 编译时缺少 [@types](https://github.com/types)/react 依赖问题 ([#4997](https://github.com/NervJS/taro/issues/4997)) ([da48a2a](https://github.com/NervJS/taro/commit/da48a2a))
* **components-qa:** 修复页面 onReachBottom 事件不触发的问题 ([b13cc81](https://github.com/NervJS/taro/commit/b13cc81))
* **components-qa:** 改进 button 动画效果展示，引入 css 属性描述文件 ([#4898](https://github.com/NervJS/taro/issues/4898)) ([706c6de](https://github.com/NervJS/taro/commit/706c6de))
...
* **mini-runner:** 修复 sass 变量失效的问题，close [#4893](https://github.com/NervJS/taro/issues/4893) ([5a10ca5](https://github.com/NervJS/taro/commit/5a10ca5))
...
* **mini-runner:** 修复 watch 时文件报错导致无法重新编译的问题，fix [#4949](https://github.com/NervJS/taro/issues/4949) ([33b73cf](https://github.com/NervJS/taro/commit/33b73cf))
* **mini-runner:** 修复 windows 下编译后 taro 引用错误的问题 ([1ca7fbb](https://github.com/NervJS/taro/commit/1ca7fbb))
...
* **mini-runner:** 修复小程序编译时样式中引用静态资源转换为 base64 ([90c62f5](https://github.com/NervJS/taro/commit/90c62f5))
...
* **mini-runner:** 修正快应用pages中ux文件未正确生成问题 ([#4969](https://github.com/NervJS/taro/issues/4969)) ([eb0ca66](https://github.com/NervJS/taro/commit/eb0ca66))
* **mini-runner:** 加上文件编译提示 ([61eef34](https://github.com/NervJS/taro/commit/61eef34))
* **mini-runner:** 加入 preval 支持 ([73c0d0f](https://github.com/NervJS/taro/commit/73c0d0f))
* **mini-runner:** 只有 taro 的包不能经过依赖包名替换 ([498cc7f](https://github.com/NervJS/taro/commit/498cc7f))
* **mini-runner:** 快应用页面路径编译错误 ([f8b63db](https://github.com/NervJS/taro/commit/f8b63db))
...
* **mini-runner:** 组件中 $componentPath 路径生成不对 ([d6d279e](https://github.com/NervJS/taro/commit/d6d279e))
* **mini-runner:** 组件引入支持统一从一个入口文件中引入 ([55f6800](https://github.com/NervJS/taro/commit/55f6800))
* **mini-runner:** 组件引用支持 import as 语法 ([6bdda04](https://github.com/NervJS/taro/commit/6bdda04))
...
* **template:** 更新 Taro 2.0 的模版和下载地址 [#4837](https://github.com/NervJS/taro/issues/4837) ([6949636](https://github.com/NervJS/taro/commit/6949636))
...
* **components-qa:** 增强快应用button组件，增加属性判断及点击变色等 ([#4882](https://github.com/NervJS/taro/issues/4882)) ([fd982c5](https://github.com/NervJS/taro/commit/fd982c5))
...
* **taro-cli:** 配置文件分开存放，优化 taro config 输出 ([2d3d96c](https://github.com/NervJS/taro/commit/2d3d96c))
