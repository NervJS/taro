...
# [2.0.0-beta.1](https://github.com/NervJS/taro/compare/v1.3.24...v2.0.0-beta.1) (2019-11-13)


### Bug Fixes

* **mini-runner:** 移除无用代码 ([f77fe24](https://github.com/NervJS/taro/commit/f77fe24))
* somethings no need ([f56e8fa](https://github.com/NervJS/taro/commit/f56e8fa))
* **cli:** lerna 加入 taro-mini-runner && 接入 webpack 生成小程序文件 ([1dd92b5](https://github.com/NervJS/taro/commit/1dd92b5))
* **cli:** 修复 doctor 对 config 的检测 ([4c2cce5](https://github.com/NervJS/taro/commit/4c2cce5))
* **cli:** 修复 watch 时文件修改不对的问题 ([d67e9aa](https://github.com/NervJS/taro/commit/d67e9aa))
* **cli:** 修复代码合并的问题 ([2fbcb0e](https://github.com/NervJS/taro/commit/2fbcb0e))
* **cli:** 修复目录创建 ([e198318](https://github.com/NervJS/taro/commit/e198318))
* **cli:** 修复配置文件中读取不到 process.env.TARO_ENV 的问题 ([dd10728](https://github.com/NervJS/taro/commit/dd10728))
* **cli:** 支持引用 node_modules 中组件 ([516b07a](https://github.com/NervJS/taro/commit/516b07a))
* **cli:** 普通文件经过编译器编译必须传入 isNormal ([364792e](https://github.com/NervJS/taro/commit/364792e))
* **cli:** 更新默认模板 ([7f3fb1f](https://github.com/NervJS/taro/commit/7f3fb1f))
* **cli:** 清理代码 ([6ca3afb](https://github.com/NervJS/taro/commit/6ca3afb))
* **cli:** 编译器参数调整 ([f463383](https://github.com/NervJS/taro/commit/f463383))
* **components-qa:** 修复页面 onReachBottom 事件不触发的问题 ([7bcf9a2](https://github.com/NervJS/taro/commit/7bcf9a2))
* **jd:** 修复合并代码导致的京东小程序的编译问题 ([43ca063](https://github.com/NervJS/taro/commit/43ca063))
* **mini-runner:** npm 中文件不会经过 taro 包替换操作 ([12aa04e](https://github.com/NervJS/taro/commit/12aa04e))
* **mini-runner:** 优化 webpack 编译时样式处理 ([7974bb6](https://github.com/NervJS/taro/commit/7974bb6))
* **mini-runner:** 修复 builder 的 hooks 调用 ([8e926c9](https://github.com/NervJS/taro/commit/8e926c9))
* **mini-runner:** 修复 tabbar 编译及组件 watch 的问题 ([f8463fe](https://github.com/NervJS/taro/commit/f8463fe))
* **mini-runner:** 修复 watch bug ([ff7d03a](https://github.com/NervJS/taro/commit/ff7d03a))
* **mini-runner:** 修复对 css modules 的支持 ([6846a32](https://github.com/NervJS/taro/commit/6846a32))
* **mini-runner:** 修复小程序编译报错 ([43c249f](https://github.com/NervJS/taro/commit/43c249f))
* **mini-runner:** 修复引用 npm 中组件间存在依赖时依赖路径解析错误的问题 ([06c710a](https://github.com/NervJS/taro/commit/06c710a))
* **mini-runner:** 修复快应用打包报错的问题 ([d344356](https://github.com/NervJS/taro/commit/d344356))
* **quickapp:** pull-down-refresh page-scroll ([51aecca](https://github.com/NervJS/taro/commit/51aecca))
* position linter for quickapp 1060+ ([597751e](https://github.com/NervJS/taro/commit/597751e))
* quickapp api upload from docs ([d77e171](https://github.com/NervJS/taro/commit/d77e171))
* **mini-runner:** 修复快应用编译后页面标题展示不正确的问题 ([949ff15](https://github.com/NervJS/taro/commit/949ff15))
* **mini-runner:** 修复普通小程序编译的问题 ([c810cc6](https://github.com/NervJS/taro/commit/c810cc6))
* **mini-runner:** 加上文件编译提示 ([39182d0](https://github.com/NervJS/taro/commit/39182d0))
* **mini-runner:** 只有 taro 的包不能经过依赖包名替换 ([ed532bd](https://github.com/NervJS/taro/commit/ed532bd))
* **mini-runner:** 打包优化，引用自 npm 包中的组件不抽离至 vendors 中 ([df344df](https://github.com/NervJS/taro/commit/df344df))
* **mini-runner:** 提前解析快应用页面 ([ce1658b](https://github.com/NervJS/taro/commit/ce1658b))
* **mini-runner:** 支持快应用编译后模板与样式的检测 ([13226d4](https://github.com/NervJS/taro/commit/13226d4))
* **taro:** 修复快应用下拉刷新问题 ([31d412b](https://github.com/NervJS/taro/commit/31d412b))
* **taro:** 小程序 webpack 编译静态文件路径 ([b0000cc](https://github.com/NervJS/taro/commit/b0000cc))
* **taro-quickapp:** 修复快应用事件绑定异常问题 ([b1e34a7](https://github.com/NervJS/taro/commit/b1e34a7))
* pxtransform disable on quick-app ([c54c3f2](https://github.com/NervJS/taro/commit/c54c3f2))
* **transformer:** 修复测试用例 ([bec729f](https://github.com/NervJS/taro/commit/bec729f))
* **transformer:** 修复错误类型 ([0083d09](https://github.com/NervJS/taro/commit/0083d09))
* **transformer:** 支持直接 import  default ([812939e](https://github.com/NervJS/taro/commit/812939e))
* **webpack:** 修复文件压缩的问题 ([c5638e5](https://github.com/NervJS/taro/commit/c5638e5))


### Features

* audio context ([f8517d1](https://github.com/NervJS/taro/commit/f8517d1))
* mock for quickapp ([9b75914](https://github.com/NervJS/taro/commit/9b75914))
* stop trans asset for quickapp ([1d82323](https://github.com/NervJS/taro/commit/1d82323))
* **cli:** cli 支持事件 && 小程序编译配置向 H5 看齐 ([5e76fd4](https://github.com/NervJS/taro/commit/5e76fd4))
* **cli:** 借助 tapable 改造 ([f71f3c2](https://github.com/NervJS/taro/commit/f71f3c2))
* **cli:** 增加 tapable 包 ([f433442](https://github.com/NervJS/taro/commit/f433442))
* **cli:** 将 app/页面/组件 添加到入口文件进行编译 ([993d7a5](https://github.com/NervJS/taro/commit/993d7a5))
* **cli:** 尝试接入 webpack 来编译各端小程序 ([ed6139f](https://github.com/NervJS/taro/commit/ed6139f))
* **cli:** 拆分逻辑到 loader ([03ae967](https://github.com/NervJS/taro/commit/03ae967))
* **cli:** 调整文件编译 ([ca7ba4c](https://github.com/NervJS/taro/commit/ca7ba4c))
* **mini-runner:** 优化 watch ([85423cc](https://github.com/NervJS/taro/commit/85423cc))
* **mini-runner:** 保证快应用文件生成正确 ([23dc443](https://github.com/NervJS/taro/commit/23dc443))
* **mini-runner:** 加入 watch ([befaabc](https://github.com/NervJS/taro/commit/befaabc))
* **mini-runner:** 增加 Taro 模块专有处理插件 ([50e453b](https://github.com/NervJS/taro/commit/50e453b))
* **mini-runner:** 支持与原生小程序代码混写 ([adcda4e](https://github.com/NervJS/taro/commit/adcda4e))
* **mini-runner:** 支持分包 ([3eacc5d](https://github.com/NervJS/taro/commit/3eacc5d))
* **mini-runner:** 支持编译 tabBar 上引用的资源编译 ([fd0bb3b](https://github.com/NervJS/taro/commit/fd0bb3b))
* **mini-runner:** 生成快应用页面及组件 ([9bc9100](https://github.com/NervJS/taro/commit/9bc9100))
* **taro:** cli 配合 mini-runner 重构 && 支持使用 mini-runner 编译插件 ([3f5df37](https://github.com/NervJS/taro/commit/3f5df37))
* **taro:** 加入快应用编译支持 ([867237d](https://github.com/NervJS/taro/commit/867237d))
* **taro:** 调整小程序和 H5 的编译配置 ([6d2e73e](https://github.com/NervJS/taro/commit/6d2e73e))
* **taro-cli:** 调整 rn 编译配置 ([f4753ae](https://github.com/NervJS/taro/commit/f4753ae))
* **taro-mini-runner:** 优化文件生成 ([e9fd763](https://github.com/NervJS/taro/commit/e9fd763))
* **taro-mini-runner:** 如果是组件需要补充 component:true 配置 ([ff6578e](https://github.com/NervJS/taro/commit/ff6578e))
* **taro-mini-runner:** 引入拆分的公共 chunks ([ba1b5c6](https://github.com/NervJS/taro/commit/ba1b5c6))
* **taro-mini-runner:** 拆分文件编译成为 plugin ([0514e3d](https://github.com/NervJS/taro/commit/0514e3d))
* **taro-mini-runner:** 生成多端类型文件 ([036e8d6](https://github.com/NervJS/taro/commit/036e8d6))
* **taro-mini-runner:** 生成页面以及组件的 usingComponents 配置 ([3f7415c](https://github.com/NervJS/taro/commit/3f7415c))
