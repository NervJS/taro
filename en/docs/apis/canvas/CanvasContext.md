...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.html)
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>The fill color.用法同 [CanvasContext.setFillStyle()]。</td>
    </tr>
    <tr>
      <td>font</td>
      <td><code>string</code></td>
    ...
    <tr>
      ...
      <td>线条的交点样式。The intersection style of the line, used in the same way as [CanvasContext.setLineJoin()]。</td>
    </tr>
    <tr>
      <td>lineWidth</td>
      <td><code>number</code></td>
      <td>线条的宽度。The width of the line, used in the same way as [CanvasContext.setLineWidth()]。</td>
    </tr>
    <tr>
      <td>miterLimit</td>
      <td><code>number</code></td>
      <td>最大斜接长度。The maximum miter length, used in the same ways as [CanvasContext.setMiterLimit()]。</td>
    </tr>
    <tr>
      <td>shadowBlur</td>
      <td><code>number</code></td>
    ...
    <tr>
      <td>strokeStyle</td>
      <td><code>string</code></td>
      <td>The border color.The border color, used in the same way as [CanvasContext.setFillStyle()]。</td>
    </tr>
  </tbody>
</table>
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.arc.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.arcTo.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.beginPath.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.bezierCurveTo.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.clearRect.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.clip.html)
...
关闭一个路径。会连接起点和终点。Closes a path by connecting the start and end points. If you do not call `fill` or `stroke` and start a new path after closing the path, the previous path will not be rendered.

> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.closePath.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.createPattern.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.draw.html)
...
<table>
  ...
  <tbody>
    <tr>
      <td>reserve</td>
      <td><code>boolean</code></td>
      <td>本次绘制是否接着上一次绘制。Indicates whether this drawing follows the previous drawing. If the reserve parameter is false (default), the native layer clears the canvas before drawing the content of this call. If the reserve parameter is true, the content on the current canvas is retained and the content of the drawCanvas call is drawn over it.</td>
    </tr>
    <tr>
      <td>callback</td>
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.drawImage.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.fill.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.fillRect.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.fillText.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.lineTo.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.moveTo.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.quadraticCurveTo.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.rect.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.restore.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.rotate.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.save.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.scale.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setFillStyle.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setFontSize.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setGlobalAlpha.html)
...
<table>
  ...
  <tbody>
    <tr>
      <td>alpha</td>
      <td><code>number</code></td>
      <td>The transparency.范围 0-1，0 表示完全透明，1 表示完全不透明。</td>
    </tr>
  </tbody>
</table>
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setLineCap.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setLineDash.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setLineJoin.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setLineWidth.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setMiterLimit.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setShadow.html)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>blur</td>
      <td><code>number</code></td>
      <td>The fuzziness level of the shadow. Higher values indicate greater fuzziness.范围 0- 100。The default value is 0.</td>
    </tr>
    <tr>
      <td>color</td>
      <td><code>string</code></td>
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setStrokeStyle.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setTextAlign.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setTextBaseline.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.setTransform.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.stroke.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.strokeRect.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.strokeText.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.transform.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.translate.html)
...
Measures the text size.目前仅返回文本宽度。同步接口。

> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.measureText.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.createCircularGradient.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/canvas/CanvasContext.createLinearGradient.html)
