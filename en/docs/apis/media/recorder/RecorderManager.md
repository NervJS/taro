...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.onError.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.onFrameRecorded.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.onInterruptionBegin.html)
...
监听录音中断结束事件。Listens on the event that recording interruption ends. After the interruptionBegin event is received, all recording in the Mini Program is paused. After this event is received, recording can be started again.

> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.onInterruptionEnd.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.onPause.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.onResume.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.onStart.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.onStop.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.pause.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.resume.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.start.html)
...
> [Reference](https://developers.weixin.qq.com/miniprogram/dev/api/media/recorder/RecorderManager.stop.html)
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>number</code></td>
      <td style={{ textAlign: "center"}}>No</td>
      <td>Specifies the frame size (in KB).传入 frameSize 后，每录制指定帧大小的内容后，会回调录制的文件内容，不指定则不会回调。Only MP3 format is supported.</td>
    </tr>
    <tr>
