...
2. The CLI reads **template source** configuration items from the CLI global configuration, and then pulls templates from the template source for developers to choose from.
