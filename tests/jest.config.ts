...
const config: Config = {
  ...
  moduleNameMapper: {
    '^globby$': '<rootDir>/__tests__/bundled/globby/index.js',
    '@pmmmwh/react-refresh-webpack-plugin': '<rootDir>/__tests__/mocks/react-refresh',
    '@prefresh/webpack': '<rootDir>/__tests__/mocks/react-refresh',
  },
  preset: 'ts-jest',
