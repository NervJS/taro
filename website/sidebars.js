module.exports = {
  ...
  components: {
    ...
    基础内容: ['components/base/icon', 'components/base/text', 'components/base/progress', 'components/base/rich-text'],
    表单组件: [
    ...
    导航: ['components/navig/navigator'],
    媒体组件: ['components/media/audio', 'components/media/image', 'components/media/video', 'components/media/camera'],
    地图: ['components/maps/map'],
    画布: ['components/canvas/canvas'],
    开放能力: [
      'components/open/ad',
  ...
  API: {
    关于API: ['apis/about/desc', 'apis/about/tarocomponent', 'apis/about/env', 'apis/about/events'],
    设备: [
      {
        label: '加速度计',
        type: 'category',
      ...
      },
      {
        label: '剪贴板',
        type: 'category',
        items: ['apis/device/clipboard/getClipboardData', 'apis/device/clipboard/setClipboardData'],
      },
      {
        label: '罗盘',
        type: 'category',
      ...
      },
      {
        label: '联系人',
        type: 'category',
        items: ['apis/device/contacts/addPhoneContact'],
      },
      {
        label: 'iBeacon',
        type: 'category',
      ...
      },
      {
        label: '网络',
        type: 'category',
        items: ['apis/device/netstat/getNetworkType', 'apis/device/netstat/onNetworkStatusChange'],
      },
      {
        label: 'NFC',
        type: 'category',
      ...
      },
      {
        label: '电话',
        type: 'category',
        items: ['apis/device/phone/makePhoneCall'],
      },
      {
        label: '扫码',
        type: 'category',
        items: ['apis/device/scancode/scancode'],
      },
      {
        label: '屏幕',
        type: 'category',
        items: ['apis/device/screenshot/onUserCaptureScreen'],
      },
      {
        label: '振动',
        type: 'category',
        items: ['apis/device/vibrate/vibrateLong', 'apis/device/vibrate/vibrateShort'],
      },
      {
        label: '系统信息',
        type: 'category',
    ...
    扩展API: ['apis/extend-apis/arrayBufferToBase64', 'apis/extend-apis/base64ToArrayBuffer'],
    文件: [
    ...
    界面: [
      {
        label: '动画',
        type: 'category',
        items: ['apis/interface/animation/createAnimation'],
      },
      {
        label: '画布',
        type: 'category',
      ...
      },
      {
        label: '滚动',
        type: 'category',
        items: ['apis/interface/pagescroll/pageScrollTo'],
      },
      {
        label: '下拉刷新',
        type: 'category',
      ...
      },
      {
        label: '顶栏',
        type: 'category',
        items: ['apis/interface/topbar/setTopBarText'],
      },
      {
        label: '窗口',
        type: 'category',
        items: ['apis/interface/window/onWindowResize', 'apis/interface/window/offWindowResize'],
      },
      {
        label: 'wxml',
        type: 'category',
    ...
    位置: ['apis/location/getLocation', 'apis/location/openLocation', 'apis/location/chooseLocation'],
    媒体: [
      {
        label: '音频',
        type: 'category',
      ...
      },
      {
        label: '相机',
        type: 'category',
        items: ['apis/multimedia/camera/createCameraContext'],
      },
      {
        label: '图片',
        type: 'category',
      ...
      },
      {
        label: '地图',
        type: 'category',
        items: ['apis/multimedia/map/createMapContext'],
      },
      {
        label: '录音',
        type: 'category',
        items: ['apis/multimedia/recording/startRecord', 'apis/multimedia/recording/stopRecord'],
      },
      {
        label: '视频',
        type: 'category',
    ...
    网络: [
      {
        label: '文件上传/下载',
        type: 'category',
        items: ['apis/network/fileTransfer/uploadFile', 'apis/network/fileTransfer/downloadFile'],
      },
      {
        label: '请求',
        type: 'category',
        items: ['apis/network/request/request', 'apis/network/request/addInterceptor'],
      },
      {
        label: 'WebSocket',
        type: 'category',
    ...
    开放接口: [
      {
        label: '地址',
        type: 'category',
        items: ['apis/open-api/address/chooseAddress'],
      },
      {
        label: '认证',
        type: 'category',
        items: ['apis/open-api/auth/authorize'],
      },
      {
        label: '生物认证',
        type: 'category',
      ...
      },
      {
        label: '卡券',
        type: 'category',
        items: ['apis/open-api/card/addCard', 'apis/open-api/card/openCard'],
      },
      {
        label: '发票',
        type: 'category',
        items: ['apis/open-api/invoice/chooseInvoice', 'apis/open-api/invoice/chooseInvoiceTitle'],
      },
      {
        label: '登录',
        type: 'category',
        items: ['apis/open-api/login/login', 'apis/open-api/login/checkSession'],
      },
      {
        label: '支付',
        type: 'category',
        items: ['apis/open-api/payment/faceVerifyForPay', 'apis/open-api/payment/requestPayment'],
      },
      {
        label: '跳转小程序',
        type: 'category',
        items: ['apis/open-api/redirect/navigateBackMiniProgram', 'apis/open-api/redirect/navigateToMiniProgram'],
      },
      {
        label: '设置',
        type: 'category',
        items: ['apis/open-api/settings/getSetting', 'apis/open-api/settings/openSetting'],
      },
      {
        label: '用户信息',
        type: 'category',
        items: ['apis/open-api/userinfo/getUserInfo'],
      },
      {
        label: '微信运动',
        type: 'category',
        items: ['apis/open-api/werun/getWeRunData'],
      },
    ],
    数据缓存: [
    ...
    更新: ['apis/updates/getUpdateManager'],
  },
}
